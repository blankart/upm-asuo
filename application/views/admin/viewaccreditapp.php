      ...
      function viewDocuments(myID){
        $.ajax({
         ...
         "<object data='<?php echo base_url(); ?>assets/org/accreditation/form_G/"+result['form_G']+"' type='pdf' width='100%' height='800'>"+
           "<iframe src='<?php echo base_url(); ?>assets/org/accreditation/form_G/"+result['form_G']+"'style='border: none; margin-left: 10px;' width='100%' height='800'>This browser does not support PDFs. Please download the PDF to view it: <a href='<?php echo base_url(); ?>assets/org/accreditation/form_G/"+result['form_G']+"'>Download PDF<\/a>"+
           "<\/iframe><\/object>"+
         "<\/div>"+
