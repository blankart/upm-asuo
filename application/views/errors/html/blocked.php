	...
	<div class="wrapper animated bounceIn" style="margin-top: 80px;">
		...
		<div class="container-fluid" id="body-container-fluid">
			<div class="container">
				...
				<h3 class="display-3"><center>Blocked Account</h3>
				<p class="lower-case"><center>Your account has been blocked by the admin. For inquiries, please proceed to OSA.</p>
