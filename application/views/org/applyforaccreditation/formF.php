                ...
                <div class="col-4">
                    <div class="card" id="ProfileDetails">
                        <div class="card-body">
                            ...
                            <button class="btn btn-secondary btn-block active" style="margin-top: 10px;" type="button" data-toggle="modal" onclick="location.href = '<?php echo base_url(); ?>org/formF';"><i style='float: left;'></i>Activity Report</button>
               ...
               <div class="col-8">
                    <div class="card" style="box-shadow: 0 0 40px rgba(0,0,0,.2); height: 500px;">
                        <div class='card-header home-header'>
                           <h4 id="pd">Form F: Activity Report</h4> 
                        </div>
                        ...
                        <p>&nbsp;&nbsp;For the document template, &nbsp; <a href="<?php echo base_url(); ?>assets/org/accreditation/form_F/formF_template.docx" download>Click Here.</a></p>
