...
<html class="no-js">
    ...
    <script>
      $(document).ready(function(){
        $('#uploadPlans').on("submit",function(e){
               e.preventDefault();
               $.ajax({
                  type: "post",
                  url :"<?php echo base_url(); ?>org/uploadPlans", 
                  async: false,
                  cache: false,
                  contentType: false,
                  processData: false,
                ...
                <div class="col-4">
                    <div class="card" id="ProfileDetails">
                        ...
                        <div class="card-body">
                            ...
                            <button class="btn btn-secondary btn-block active" style="margin-top: 10px;" type="button" data-toggle="modal" onclick="location.href = '<?php echo base_url(); ?>org/plans';"><i style='float: left;'></i>Plans</button> 
               ...
               <div class="col-8">
                    <div class="card" style="box-shadow: 0 0 40px rgba(0,0,0,.2); height: 500px;">
                        <div class='card-header home-header'>
                            <?php if($org_accred_status == "new"){
                              echo "<h4>Plans for the Academic Year</h4>";
                            }
                            else{
                              echo "<h4>Tentative Plans for Current Academic Year</h4>";
                            }?> 
                        </div>
                        ...
                        <div class="card-body">
                          <div class="content" id="cont1">
                            <div class="box">
                            <form enctype="multipart/form-data" method='POST' id='uploadPlans'>
                              <input type="file" name="plans" id="file-to-upload" class="inputfile inputfile-1" data-multiple-caption="{count} files selected" accept="application/pdf" multiple/>
                              ...
                              <div class="myBtn">
                                <button class="btn btn-danger" id="prevBtn" onclick="location.href = '<?php echo base_url(); ?>org/plans';">Preview</button> 
                                <button class="btn btn-danger" id="prevBtn" onclick="document.getElementById('submitPlans').click();">Upload</button> 

                              </div>
                            </div>
                          </div>
                      </form>
                        <p>&nbsp;&nbsp;For the document template, &nbsp; <a href="<?php echo base_url(); ?>assets/org/accreditation/plans/plans_template.docx" download>Click Here.</a></p>
