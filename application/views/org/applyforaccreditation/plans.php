...
<html class="no-js">
	...
	<body>
   		<div class="animated fadeIn" id="panel">
			...
			<div class="main">
				<?php 
					if($org_accred_status == "new"){
						echo "<h1>Plans for the Academic Year</h1>";
					}
					else{
						echo "<h1>Tentative Plans for Current Academic Year</h1>";
					}
				?>
            ...
            <div class="content" id="cont2" style="display: none;">
              <div class="box">
                ...
                <div class="myBtn">
                  <button class="btn btn-danger" id ='submitPlans' onclick="document.getElementById('submitPlans').click();" >Upload</button>
