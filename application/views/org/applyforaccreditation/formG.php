	...
	<body>
          ...
          <div class="main">
            ...
            <div class="content" id="cont1">
              <div class="box">
                <form enctype="multipart/form-data" id="submitFormG" method='POST' onsubmit='return false;'>
            ...
            <div class="content" id="cont2" style="display: none;">
              <div class="box">
                ...
                <div class="myBtn">
                  <button class="btn btn-danger" id ='submitFormG' onclick="document.getElementById('submitFormG').click();">Upload</button>
