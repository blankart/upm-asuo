            ...
            <div class="row">
                <div class="col-4">
                    <div class="card" id="ProfileDetails" style="box-shadow: 0 0 40px rgba(0,0,0,.2);">
                        ...
                        <div class="card-body">
                            <img src="<?php echo base_url().'assets/org/logo/'.$profile['org_logo']; ?>" style="position: relative; margin-left: 80px; border-radius: 50%; border-style: solid; border-width: medium; border-color: white; box-shadow: 0 0 40px rgba(0,0,0,.2); align-items: center;" width="150">
